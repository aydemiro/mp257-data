...
## figure_1_supplements_1-2_t1d_cph
#### COX Proportional Hazards Model for Type 1 diabetes Outcome
[This notebook](figure_1_figure_supplements_3-4_ia_cph/t1d_cox_PH_models.ipynb) contains the code for generating figure 1-supplements 1 and 2.  
It should be referenced for Cox PH model code for other notebooks as it is commented with detailed explanations.
## figure_1_supplements_3-4_ia_cph
#### COX Proportional Hazards Model for Islet Autoantibody Outcome  

[This notebook](figure_S3_S4_ia_cph/islet_autoantibody_cox_PH_models.ipynb) contains the code for generating figure 1-supplements 3 and 4.  

## figure_1_supplements_5-6_gada_cph
#### COX Proportional Hazards Model for GADA-first Outcome
[This notebook](figure_1_figure_supplements_5-6_gada_cph/gada_cox_PH_models.ipynb) contains the code for generating figure 1-supplements 5 and 6. 

## figure_1_supplements_7-8_iaa_cph
#### COX Proportional Hazards Model for IAA-first Outcome  

[This notebook](figure_1_figure_supplements_7-8_iaa_cph/iaa_cox_PH_models.ipynb) contains the code for generating figure 1-supplements 7 and 8.  

## figure_1_supplements_9-10_cd_cph
#### COX Proportional Hazards Model for Celiac Disease Outcome  
[This notebook](figure_1_figure_supplements_9-10_cd_cph/cd_cox_PH_models.ipynb) contains the code for generating figure 1-supplements 9 and 10.  

## figure_1_supplements_11-12_cda_cph
#### COX Proportional Hazards Model for Celiac Disease Autoantibody Outcome  
[This notebook](figure_1_figure_supplements_11-12_cda_cph/cda_cox_PH_models.ipynb) contains the code for generating figure 1-supplements 11 and 12.  
